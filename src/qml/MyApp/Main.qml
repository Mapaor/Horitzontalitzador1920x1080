...
Window {
    ...
    ColumnLayout {
        ...
        ConfigPanel {
            ...
            visible: mainWindow.isVideoLoaded
            onOpenConfig: (extra) => {
                if (extra === "Marc") appPopups.openFramePopup()
                else if (extra === "Overlay") appPopups.openOverlayPopup()
            }
        }
        ...
        FooterPanel {
            ...
            onOutputNameChanged: {
                if(outputName !== ioPanel.outputName) ioPanel.outputName = outputName;
            }
            onOutputDirChanged: {
                if(outputDir !== ioPanel.outputDir) ioPanel.outputDir = outputDir;
            }
            ...
            onPreviewClicked: {
                ...
                videoConverter.preview(
                    mainWindow.videoPath,
                    mainWindow.blurValue,
                    mainWindow.darknessValue,
                    mainWindow.modeText,
                    mainWindow.extraText === "Marc",
                    mainWindow.frameColor,
                    mainWindow.frameWidth,
                    mainWindow.extraText === "Overlay" ? mainWindow.overlayPath : "",
                    mainWindow.enableOverlayRecolor,
                    mainWindow.overlayColor
                )
            }
        ...
        Item { Layout.fillHeight: true } // Spacer at bottom
    }
